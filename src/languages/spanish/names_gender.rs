...
fn guess_name_gender_heuristic(name: &str) -> Option<Gender> {
    ...
    let possible_surnames = [
        "garcía", "mejía", "iniesta", "peña", "ojeda", "estrada", "ortega", "sosa", "vega", "mora",
        "herrera", "silva", "rivera", "serna", "sierra", "victoria", "valencia", "costa", "rocha",
        "ayala", "acosta", "espinoza", "ochoa", "araya", "guerra", "varela", "zúñiga", "barrera",
        "aldea", "roca", "iglesia", "rueda", "baena", "cuesta", "dueña", "estrella",
    ];
